// When an admin uses ImpersonationBar to "view as another role", we replace —
// not augment — the effective role set with a single group. Pass
...
export const hasRole = (authState, roleName, options = {}) => {
  ...
  if (!ignoreImpersonation && authState?.impersonatedRole) {

...
const renderBadge = count =>
  ...
  'box-sizing:border-box;background:#d32f2f;color:#fff;' +
...
const renderIconHtml = (color, count) =>
  ...
  (count > 1 ? renderBadge(count) : '') +
  '</div>';

export const makeDocPinIcon = (color, count) =>
  divIcon({
    className: 'topo-doc-pin',
    html: renderIconHtml(color, count),

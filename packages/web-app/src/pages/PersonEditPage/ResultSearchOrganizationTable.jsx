...
import SearchTableActions from '../../components/homepage/advancedSearch/SearchTableActions';
...
class SearchResultsTableOrga extends React.Component {
  constructor(props) {
    super(props);
...
SearchResultsTableOrga.propTypes = {
...
SearchResultsTableOrga.defaultProps = {
  results: undefined,
  fullResults: undefined
};

export default injectIntl(
  withRouter(withStyles(styles)(SearchResultsTableOrga))
);

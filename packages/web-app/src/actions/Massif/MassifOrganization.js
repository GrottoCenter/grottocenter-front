...
export const SET_MASSIF_ORGANIZATION_SUCCESS =
  'SET_MASSIF_ORGANIZATION_SUCCESS';
export const SET_MASSIF_ORGANIZATION_FAILURE =
  'SET_MASSIF_ORGANIZATION_FAILURE';

export const REMOVE_MASSIF_ORGANIZATION = 'REMOVE_MASSIF_ORGANIZATION';
export const REMOVE_MASSIF_ORGANIZATION_SUCCESS =
  'REMOVE_MASSIF_ORGANIZATION_SUCCESS';
export const REMOVE_MASSIF_ORGANIZATION_FAILURE =
  'REMOVE_MASSIF_ORGANIZATION_FAILURE';

export const RESET_MASSIF_ORGANIZATION = 'RESET_MASSIF_ORGANIZATION';
export const resetMassifOrganization = () => ({
  type: RESET_MASSIF_ORGANIZATION
});

// Set Actions
const setMassifOrganizationAction = () => ({ type: SET_MASSIF_ORGANIZATION });
const setMassifOrganizationSuccess = payload => ({
  type: SET_MASSIF_ORGANIZATION_SUCCESS,
  payload
});
const setMassifOrganizationFailure = error => ({
  type: SET_MASSIF_ORGANIZATION_FAILURE,
  error
});

export const setMassifOrganization =
  (massifId, organizationId, organizationName) => (dispatch, getState) => {
    ...
    return getOrgIdPromise
      .then(finalOrgId => {
        ...
        return fetch(
          putMassifOrganizationUrl(massifId, finalOrgId),
          requestOptions
        );
      })
      .then(checkAuthStatus(dispatch))
...
// Remove Actions
const removeMassifOrganizationAction = () => ({
  type: REMOVE_MASSIF_ORGANIZATION
});
const removeMassifOrganizationSuccess = payload => ({
  type: REMOVE_MASSIF_ORGANIZATION_SUCCESS,
  payload
});
const removeMassifOrganizationFailure = error => ({
  type: REMOVE_MASSIF_ORGANIZATION_FAILURE,
  error
});

export const removeMassifOrganization =
  (massifId, organizationId) => (dispatch, getState) => {
    ...
    return fetch(
      deleteMassifOrganizationUrl(massifId, organizationId),
      requestOptions
    )
      .then(checkAuthStatus(dispatch))
      .then(response => {

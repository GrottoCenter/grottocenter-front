...
**2. Show and confirm** — display the draft title and body to the user and **wait for explicit approval before proceeding**. Do not push or create the PR until the user confirms.
